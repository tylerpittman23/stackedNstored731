...
export const Navbar = ({ windowWidth }) => {
    ...
    return (
        ...
        <nav className="w-full border-2 border-black flex bg-white justify-evenly items-center py-1.5 fixed top-0 z-40">
            <Link to="/about" className="border-2 w-24 flex items-center justify-center">About</Link>
            <Link to="services" className="border-2 w-20 flex items-center justify-center">Services</Link>
            <div className="logo-container border-2 w-96 h-40 flex items-center justify-center">
                <Link to="/" className="">LOGO</Link>
            </div>
            <Link to="/projects" className="border-2 w-20 flex items-center justify-center">Projects</Link>
            <Link to="/contact" className="border-2 w-20 flex items-center justify-center">Contact</Link>
        </nav>
        ) : ( <>
