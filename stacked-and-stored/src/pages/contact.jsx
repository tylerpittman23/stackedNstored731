...
export const Contact = () => {
    ...
    return (
        <>
        <div className="h-full flex flex-col bg-white justify-center items-center w-full pt-52">
            <div className="card relative w-11/12 p-4 mb-10 max-w-screen-lg shadow-md">
            ...
            <div className="border-2 border-gray-300 shadow-md rounded-md w-11/12 p-4 relative mb-10 max-w-screen-md">
                <ContactForm />
            </div>
        </div>    
        </>
